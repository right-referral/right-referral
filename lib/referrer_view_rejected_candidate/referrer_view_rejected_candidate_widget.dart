...
class ReferrerViewRejectedCandidateWidget extends StatefulWidget {
  const ReferrerViewRejectedCandidateWidget({
    Key key,
  ...
  @override
  _ReferrerViewRejectedCandidateWidgetState createState() =>
      _ReferrerViewRejectedCandidateWidgetState();
}

class _ReferrerViewRejectedCandidateWidgetState
    extends State<ReferrerViewRejectedCandidateWidget>
        ...
        child: StreamBuilder<List<UsersRecord>>(
          stream: queryUsersRecord(
            queryBuilder: (usersRecord) => usersRecord
                .where('uid', isEqualTo: widget.candidateUidParam)
