import '../admin_view_candidate/admin_view_candidate_widget.dart';
import '../backend/backend.dart';
import '../components/admin_approve_b_s_widget.dart';
import '../components/admin_reject_b_s_widget.dart';
...
class AdminPendingApprovalListWidget extends StatefulWidget {
  const AdminPendingApprovalListWidget({Key key}) : super(key: key);

  @override
  _AdminPendingApprovalListWidgetState createState() =>
      _AdminPendingApprovalListWidgetState();
}

class _AdminPendingApprovalListWidgetState
    extends State<AdminPendingApprovalListWidget> {
