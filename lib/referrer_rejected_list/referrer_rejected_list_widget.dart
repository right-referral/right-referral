...
import '../referrer_view_rejected_candidate/referrer_view_rejected_candidate_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_spinkit/flutter_spinkit.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:infinite_scroll_pagination/infinite_scroll_pagination.dart';

class ReferrerRejectedListWidget extends StatefulWidget {
  const ReferrerRejectedListWidget({Key key}) : super(key: key);

  @override
  _ReferrerRejectedListWidgetState createState() =>
      _ReferrerRejectedListWidgetState();
}

class _ReferrerRejectedListWidgetState
    extends State<ReferrerRejectedListWidget> {
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      await Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              ReferrerViewRejectedCandidateWidget(
                                            candidateUidParam:
                                                listViewAppliedJobsRecord
                                                    .candidateUid,
                                            jobIdParam:
