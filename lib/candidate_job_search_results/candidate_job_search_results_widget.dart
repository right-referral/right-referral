...
class CandidateJobSearchResultsWidget extends StatefulWidget {
  const CandidateJobSearchResultsWidget({
    Key key,
    this.location,
    this.company,
    this.domain,
  ...
  @override
  _CandidateJobSearchResultsWidgetState createState() =>
      _CandidateJobSearchResultsWidgetState();
}

class _CandidateJobSearchResultsWidgetState
    extends State<CandidateJobSearchResultsWidget> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: GestureDetector(
          ...
          child: PagedListView<DocumentSnapshot<Object>, JobPostsRecord>(
            pagingController: () {
