...
class AdminViewCandidateWidget extends StatefulWidget {
  const AdminViewCandidateWidget({
    Key key,
  ...
  @override
  _AdminViewCandidateWidgetState createState() =>
      _AdminViewCandidateWidgetState();
}

class _AdminViewCandidateWidgetState extends State<AdminViewCandidateWidget>
