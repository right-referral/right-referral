...
class RecruiterViewCandidateWidget extends StatefulWidget {
  const RecruiterViewCandidateWidget({
    Key key,
  ...
  @override
  _RecruiterViewCandidateWidgetState createState() =>
      _RecruiterViewCandidateWidgetState();
}

class _RecruiterViewCandidateWidgetState
    extends State<RecruiterViewCandidateWidget> with TickerProviderStateMixin {
  final animationsMap = {
                            ...
                            await showModalBottomSheet(
                              ...
                              builder: (context) {
                                return Padding(
                                  ...
                                  child: Container(
                                    height: 40,
                                    child: RecruiterApproveBSWidget(
                                      jobidParameter: widget.jobIdParam,
                                      candidateUIDParameter:
                                          widget.candidateUidParam,
                                      referrerUidParameter:
