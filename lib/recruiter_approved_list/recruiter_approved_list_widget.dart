...
import '../recruiter_view_approved_candidate/recruiter_view_approved_candidate_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_spinkit/flutter_spinkit.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:infinite_scroll_pagination/infinite_scroll_pagination.dart';

class RecruiterApprovedListWidget extends StatefulWidget {
  const RecruiterApprovedListWidget({Key key}) : super(key: key);

  @override
  _RecruiterApprovedListWidgetState createState() =>
      _RecruiterApprovedListWidgetState();
}

class _RecruiterApprovedListWidgetState
    extends State<RecruiterApprovedListWidget> {
                  ...
                  final Query<Object> Function(Query<Object>) queryBuilder =
                      (appliedJobsRecord) => appliedJobsRecord
                          ...
                          .where('admin_verification_status',
                              isEqualTo: 'Approved')
                          .where('recruiter_acceptance_status',
                              isEqualTo: 'Approved')
                                          ...
                                          FFButtonWidget(
                                            onPressed: () async {
                                              await Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                      RecruiterViewApprovedCandidateWidget(
                                                    candidateUidParam:
                                                        listViewAppliedJobsRecord
                                                            .candidateUid,
                                                    jobIdParam:
