...
class RecruiterViewApprovedCandidateWidget extends StatefulWidget {
  const RecruiterViewApprovedCandidateWidget({
    Key key,
  ...
  @override
  _RecruiterViewApprovedCandidateWidgetState createState() =>
      _RecruiterViewApprovedCandidateWidgetState();
}

class _RecruiterViewApprovedCandidateWidgetState
    extends State<RecruiterViewApprovedCandidateWidget>
