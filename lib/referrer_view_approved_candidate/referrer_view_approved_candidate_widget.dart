...
class ReferrerViewApprovedCandidateWidget extends StatefulWidget {
  const ReferrerViewApprovedCandidateWidget({
    Key key,
  ...
  @override
  _ReferrerViewApprovedCandidateWidgetState createState() =>
      _ReferrerViewApprovedCandidateWidgetState();
}

class _ReferrerViewApprovedCandidateWidgetState
    extends State<ReferrerViewApprovedCandidateWidget>
