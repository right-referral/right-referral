...
class AdminViewApprovedCandidateWidget extends StatefulWidget {
  const AdminViewApprovedCandidateWidget({
    Key key,
  ...
  @override
  _AdminViewApprovedCandidateWidgetState createState() =>
      _AdminViewApprovedCandidateWidgetState();
}

class _AdminViewApprovedCandidateWidgetState
    extends State<AdminViewApprovedCandidateWidget>
