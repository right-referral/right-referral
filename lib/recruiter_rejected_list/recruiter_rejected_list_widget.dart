...
import '../recruiter_view_rejected_candidate/recruiter_view_rejected_candidate_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_spinkit/flutter_spinkit.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:infinite_scroll_pagination/infinite_scroll_pagination.dart';

class RecruiterRejectedListWidget extends StatefulWidget {
  const RecruiterRejectedListWidget({Key key}) : super(key: key);

  @override
  _RecruiterRejectedListWidgetState createState() =>
      _RecruiterRejectedListWidgetState();
}

class _RecruiterRejectedListWidgetState
    extends State<RecruiterRejectedListWidget> {
                                          ...
                                          FFButtonWidget(
                                            onPressed: () async {
                                              await Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                      RecruiterViewRejectedCandidateWidget(
                                                    candidateUidParam:
                                                        listViewAppliedJobsRecord
                                                            .candidateUid,
                                                    jobIdParam:
