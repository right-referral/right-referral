...
import '../referrer_approved_list/referrer_approved_list_widget.dart';
...
class ReferrerLandingPageWidget extends StatefulWidget {
  const ReferrerLandingPageWidget({Key key}) : super(key: key);

  @override
  _ReferrerLandingPageWidgetState createState() =>
      _ReferrerLandingPageWidgetState();
}

class _ReferrerLandingPageWidgetState extends State<ReferrerLandingPageWidget> {
    ...
    return StreamBuilder<List<CandidateProfileRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CandidateProfileRecord>
            referrerLandingPageCandidateProfileRecordList = snapshot.data;
        final referrerLandingPageCandidateProfileRecord =
            referrerLandingPageCandidateProfileRecordList.isNotEmpty
                ? referrerLandingPageCandidateProfileRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
