import '../admin_view_rejected_candidate/admin_view_rejected_candidate_widget.dart';
...
class AdminRejectedListWidget extends StatefulWidget {
  const AdminRejectedListWidget({Key key}) : super(key: key);

  @override
  _AdminRejectedListWidgetState createState() =>
      _AdminRejectedListWidgetState();
}

class _AdminRejectedListWidgetState extends State<AdminRejectedListWidget> {
                                          ...
                                          FFButtonWidget(
                                            onPressed: () async {
                                              await Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                      AdminViewRejectedCandidateWidget(
                                                    candidateUidParam:
                                                        listViewAppliedJobsRecord
                                                            .candidateUid,
                                                    jobIdParam:
