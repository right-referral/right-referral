import '../admin_view_approved_candidate/admin_view_approved_candidate_widget.dart';
...
class AdminApprovedListWidget extends StatefulWidget {
  const AdminApprovedListWidget({Key key}) : super(key: key);

  @override
  _AdminApprovedListWidgetState createState() =>
      _AdminApprovedListWidgetState();
}

class _AdminApprovedListWidgetState extends State<AdminApprovedListWidget> {
                                          ...
                                          FFButtonWidget(
                                            onPressed: () async {
                                              await Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                      AdminViewApprovedCandidateWidget(
                                                    candidateUidParam:
                                                        listViewAppliedJobsRecord
                                                            .candidateUid,
                                                    jobIdParam:
