...
class AdminViewRejectedCandidateWidget extends StatefulWidget {
  const AdminViewRejectedCandidateWidget({
    Key key,
  ...
  @override
  _AdminViewRejectedCandidateWidgetState createState() =>
      _AdminViewRejectedCandidateWidgetState();
}

class _AdminViewRejectedCandidateWidgetState
    extends State<AdminViewRejectedCandidateWidget>
