...
class ReferrerViewCandidateWidget extends StatefulWidget {
  const ReferrerViewCandidateWidget({
    Key key,
  ...
  @override
  _ReferrerViewCandidateWidgetState createState() =>
      _ReferrerViewCandidateWidgetState();
}

class _ReferrerViewCandidateWidgetState
    extends State<ReferrerViewCandidateWidget> with TickerProviderStateMixin {
  final animationsMap = {
                                ...
                                return Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: ReferrerRejectBSWidget(
                                      jobidParameter: widget.jobIdParam,
                                      candidateUIDParameter:
                                          widget.candidateUidParam,
                                    ),
                                  ),
                                );
                              },
