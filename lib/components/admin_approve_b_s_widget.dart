...
class AdminApproveBSWidget extends StatefulWidget {
  const AdminApproveBSWidget({
    Key key,
    this.jobidParameter,
  ...
  @override
  _AdminApproveBSWidgetState createState() => _AdminApproveBSWidgetState();
}

class _AdminApproveBSWidgetState extends State<AdminApproveBSWidget> {
