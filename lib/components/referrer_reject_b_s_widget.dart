...
class ReferrerRejectBSWidget extends StatefulWidget {
  const ReferrerRejectBSWidget({
    Key key,
    this.jobidParameter,
  ...
  @override
  _ReferrerRejectBSWidgetState createState() => _ReferrerRejectBSWidgetState();
}

class _ReferrerRejectBSWidgetState extends State<ReferrerRejectBSWidget> {
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      final appliedJobsUpdateData = createAppliedJobsRecordData(
                        referrerComments: candidatecommentsController.text,
                        referrerVerificationStatus: 'Reject',
                        ...
                        recruiterApprovalDt: getCurrentTimestamp,
                        referrerAcceptanceStatus: 'Reject',
