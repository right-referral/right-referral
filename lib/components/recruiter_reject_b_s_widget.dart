...
class RecruiterRejectBSWidget extends StatefulWidget {
  const RecruiterRejectBSWidget({
    Key key,
    this.jobidParameter,
  ...
  @override
  _RecruiterRejectBSWidgetState createState() =>
      _RecruiterRejectBSWidgetState();
}

class _RecruiterRejectBSWidgetState extends State<RecruiterRejectBSWidget> {
