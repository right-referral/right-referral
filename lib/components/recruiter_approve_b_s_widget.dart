...
class RecruiterApproveBSWidget extends StatefulWidget {
  const RecruiterApproveBSWidget({
    Key key,
    this.jobidParameter,
  ...
  @override
  _RecruiterApproveBSWidgetState createState() =>
      _RecruiterApproveBSWidgetState();
}

class _RecruiterApproveBSWidgetState extends State<RecruiterApproveBSWidget> {
